$(document).ready(function () {
   ...
   $(document).on('click', '.post_appointment', function (e) {
      ...
      if (formData != "") {
         $.ajax({
            url: "https://test.3malgroup.com/models/post_appointment.php",
            type: "POST",
            data: formData,
            cache: false,
            contentType: false,
   ...
   $(document).on('click', '.contact_submit_btn', function (e) {
      ...
      if (formData != "") {
         $.ajax({
            url: "https://test.3malgroup.com/models/post_contact.php",
            type: "POST",
            data: formData,
            cache: false,
            contentType: false,
   ...
   function fetchCaseStudy() {
      ...
      $.ajax({
         url: 'https://test.3malgroup.com/models/fetch_data.php?' + fetch_caseStudy_home,
         type: 'GET',
         dataType: 'json',
         beforeSend: function () {
            ...
            if (response && response.length > 0) {
               ...
               $.each(response, function (index, data) {
                  ...
                  var dataCard = `
                     ...
                     <div class="item_box">
                     <a href="https://test.3malgroup.com/case_study/${data_id}_${header_title}">
                        <div class="img_box">
                        ...
                        <div class="text_box">
                           ...
                           <h2>${title}</h2>
                           <a href="https://test.3malgroup.com/case_study/${data_id}_${header_title}"><span>View case study</span> <span class="icon-box"><i class="bi bi-arrow-up-right"></i></span></a>
                        </div>
                        </a>
                     </div>
                  </div>`;
    ...
    let ajaxUrl = 'https://test.3malgroup.com/models/fetch_data.php?';
   ...
   function fetchBlog() {
      ...
      $.ajax({
         url: 'https://test.3malgroup.com/models/fetch_data.php?' + fetch_posts_home,
         type: 'GET',
         dataType: 'json',
         beforeSend: function () {
                     ...
                     <div class="box_wrapper">
                        ...
                        <div class="text_box">
                          <p class="date">${createdDate}</p>
                           <h2>${title}</h2>
                          <a href="https://test.3malgroup.com/article/${data.blog_id}_${header_title}">Read more <span><i class="bi bi-arrow-up-right"></i></span></a>
                        </div>
                     </div>
                  </div>
                       `;
      ...
      $.ajax({
         url: 'https://test.3malgroup.com/models/fetch_data.php?' + fetch_all_posts,
         type: 'GET',
         dataType: 'json',
         beforeSend: function () {
            $('#postContainer').html(`
   ...
   $(document).on('click', '.subscribe_btn', function (e) {
      ...
      if (formData != "") {
         $.ajax({
            url: "https://test.3malgroup.com/models/post_newsletter.php",
            type: "POST",
            data: formData,
            cache: false,
            contentType: false,
   ...
   $(document).on('click', '.enq_btn', function () {
      ...
      $('.userReachForm').submit(function (event) {
         ...
         $.ajax({
            url: "https://test.3malgroup.com/models/post_enquiry.php",
            method: "POST",
