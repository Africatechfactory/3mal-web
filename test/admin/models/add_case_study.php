...
if (isset($_POST['title'])) {
    ...
    if (empty($title)) {
        ...
        if ($uploadMultipleImagesResult === "All images uploaded successfully.") {
            ...
            $query_sql = "INSERT INTO case_study(title, body, data_id, client, start_date, end_date, tag, study_url, status, created_date, update_date, pub_status) VALUES(:title, :body, :data_id, :client, :start_date, :end_date, :tag, :study_url, :status, :created_date, :update_date, :pub_status)";
