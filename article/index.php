...
<html lang="en">
   <head>
      <?php
         ...
         ?>
      <meta property="og:title" content="<?= reverse_secure_input($title_top); ?>" />
      ...
      <title><?= reverse_secure_input($title_top); ?> - 3MAL Group</title>
   ...
   <body>
      ...
      <div class="comment_btn" target="<?= $blog_id; ?>" id="comment_btn">
         <p class="" >Comment <span class="body_row_count"></span></p>
      </div>
