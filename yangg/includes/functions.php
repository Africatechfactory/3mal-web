...
function strip_cleanUrl($string){
  ...
  $year = date("Y");
                ...
                <div style="background: #fff; background-position: center; background-repeat: no-repeat; background-size: cover; padding: 16px 10px; color: #fff;">
                   <div style="padding: 30px 15px;">
                      <div style="margin-bottom: 30px; ">
                         <img src="https://yangg.org/images/logo.png"  width="150px" height="auto" alt="Yangg" class="img-fluid">
                      </div>
                      ...
                      <div class="mail-main-body-box" style="padding: 0px 0">
                         ...
                         <div style="text-align:center; margin: 0 auto;">
                            <p style="font-size: 16px; color: #777777; line-height: 30px; font-family: \'Trebuchet MS\', sans-serif; font-weight: 300; margin-bottom: 30px;">
                               ...
                               <a href="mailto:hello@yangg.org">hello@yangg.org</a>.
                            </p>
                           <div>
                               <a style="color: #000; text-decoration: none; margin: 0 10px;" href="https://web.facebook.com/yanggofficial">
                               ...
                               <a style="color: #000; text-decoration: none; margin: 0 10px;" href="https://www.instagram.com/yanggofficial_sdg/">
                               ...
                               <a style="color: #000;text-decoration: none; margin: 0 10px;" href="https://www.linkedin.com/in/yangg-global-3510501b7/" style="padding: 0px 0">
                                <img src="https://cdn1.iconfinder.com/data/icons/social-media-circle-7/512/Circled_Linkedin_svg-256.png" alt="Facebook" width="27px" height="auto" />
                                 ...
                                 <a style="color: #000;text-decoration: none; margin: 0 10px;" href="https://twitter.com/YANGG_OFFICIAL" style="padding: 0px 0">
    ...
    $header = "From: Yangg <admin@3malgroup.com> \r\n";
