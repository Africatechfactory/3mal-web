      ...
      <div class="col-sm-2 p-0">
         <div class="left_pane">
            ...
            <ul class="navbar_nav">
               ...
               <li class="active"><a href="<?= $adminBase ?>listings/"><i class="bi bi-list-check"></i> Listings</a></li>
...
<script>
  ...
  $(document).on('click', '.add_listing_btn', function () {
    ...
    function fetchListing(postType, containerClass) {
        $.ajax({
            url: `../models/fetch_listing.php?fetch_all_listing=${postType}`,
            type: 'GET',
            dataType: 'json',
            beforeSend: function(){
    ...
    $(document).on('click', '.edit_listing_btn', function(){
        ...
        $.ajax({
            url: '../models/edit_listing_data.php',
            type: 'GET',
            dataType: 'json',
