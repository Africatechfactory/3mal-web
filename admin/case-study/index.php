      ...
      <div class="col-sm-2 p-0">
         <div class="left_pane">
            ...
            <ul class="navbar_nav">
               ...
               <li class="active"><a href="<?= $adminBase ?>case-study/"><i class="bi bi-border-style"></i> Case studies</a></li>
...
const adminBase = "<?= $adminBase ?>";
    ...
    <div class="form-group">
      <label for="client">Project category</label>
     <select name="category" class="custom-select raw_input">
      <option value="Branding">Branding</option>
      <option value="Event promotion">Event promotion</option>
      <option value="B2B2C experiential marketing">B2B2C experiential marketing</option>
  ...
  $(document).on('click', '.add_caseStudy_btn', function () {
    ...
    $('.addCaseStudy').submit(function (event) {
       ...
       $.ajax({
          url: `${adminBase}models/add_case_study.php`,
          method: "POST",
...
function fetchCaseStudy(postType, containerClass) {
    $.ajax({
        url: `${adminBase}models/fetch_casestudy.php?fetch_all_casestudy=${postType}`,
        type: 'GET',
        dataType: 'json',
        beforeSend: function (){
...
$(document).on('click', '.edit_casestudy_btn', function(){
    ...
    $.ajax({
        url: `${adminBase}models/edit_casestudy_data.php`,
        type: 'GET',
        dataType: 'json',
...
$(document).on('click', '.update_caseStudy_btn', function () {
    ...
    $('.updateCaseStudy').submit(function (event) {
       event.preventDefault();
       $.ajax({
            url: `${adminBase}models/update_casestudy.php`,
            method: "POST",
            data: new FormData(this),
            contentType: false,
            processData: false,
