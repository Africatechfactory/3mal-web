         ...
         <div class="row">
            <div class="col-sm-12 ">
               <div class="row">
                  ...
                  <div class="col-sm-12 col-12 col-md-8 col-xl-4 col-lg-4">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-12 col-12 col-xl-4 col-lg-4 col-md-8">
                     <div class="contact_info_box text-center">
                        <p><a href="tel:+2348100017925">+234 810 001 7925</a> | 
                           <a href="tel:+2347030050512">+234 703 005 0512</a>
                        </p>
                        <p><a href="mailto:info@3malgroup.com">info@3malgroup.com</a></p>
            ...
            <div class="col-sm-10">
               <div class="form-box">
                  ...
                  <form action="" method="post" class="contact_form">
                     ...
                     <div class="form-group"><button type="submit"  class="btn submit_btn contact_submit_btn">Submit  <span><i class="bi bi-arrow-right"></i></span></button></div>
                  </form>
               </div>
            </div>
            <div class="col-sm-1"></div>
